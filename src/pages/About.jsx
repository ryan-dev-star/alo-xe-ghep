...
const StarRating = () => (
  <div className="flex items-center gap-2 mt-4">
    ...
    <span className="text-gray-600 text-lg">5/5 – (4 bình chọn)</span>
  </div>
);
...
const AboutDetails = () => (
  <div className="py-12 bg-white">
    <div className="container mx-auto px-4">
      ...
      <div className="mt-16" style={{ backgroundColor: "#edfbe2" }}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-c">
          ...
          <div className="text-left" style={{ padding: "30px" }}>
            ...
            <p className="text-gray-600 leading-relaxed">
              Xe điện Vinfast sở hữu khung gầm và thân vỏ đã được khẳng định qua
              các vụ va chạm thực tế.
            </p>
          </div>
          ...
          <div className="text-left" style={{ padding: "30px" }}>
            ...
            <h4 className="box-title text-green mb-3">Dịch vụ chuyên nghiệp</h4>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="text-left" style={{ padding: "30px" }}>
            ...
            <p className="text-gray-600 leading-relaxed">
              Các tài xế của Alo Xe Ghép đã có kinh nghiệm lái xe trên 10.000km.
            </p>
          </div>
          ...
          <div className="text-left" style={{ padding: "30px" }}>
            ...
            <p className="text-gray-600 leading-relaxed">
              Xe điện đa dạng mẫu mã Xe điện VF là dòng xe SUV và nhiều loại xe
              khác với kích thước phù hợp, giúp chuyến đi của bạn thêm phần
            ...
            <div className="max-w-2xl">
              ...
              <div className="space-y-6">
                <p className="text-lg text-gray-700 leading-relaxed">
                  Dịch vụ <strong>Alo Xe Ghép</strong> sử dụng toàn bộ là xe
                  điện Vinfast cho dịch vụ của mình. <strong>AN TOÀN</strong>{" "}
                  vượt trội với hệ khung gầm chắc chắn của Vinfast.{" "}
                  <strong>Không Gian Sạch Sẽ</strong> khi sử dụng xe điện không
                  phát thải khí carbon ra môi trường.
                </p>
